...
import deeplabv2, deeplabv3, deeplabv3plus
...
def train():
    ...
    # scheduler = polylr.PolynomialLR(optimizer, step_size=args.step_size, power=0.9)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model",
                        default="/workplace/project/Fire_MODIS_v3/segmentation/DeepLab/models_save/deeplabv3plus_1.pth")

    parser.add_argument("--batch_num", default=2)
    ...
    parser.add_argument("--test_batch", default=2)
