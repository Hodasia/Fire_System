...
class MixVisionTransformer(nn.Module):
    def __init__(self, in_chans=9, num_classes=1, embed_dims=[32, 64, 160, 256],
        ...
        #-----------------------------------------------#
        self.patch_embed1 = OverlapPatchEmbed(patch_size=3, stride=1, in_chans=in_chans, embed_dim=embed_dims[0])
        ...
        #-----------------------------------------------#
        self.patch_embed2 = OverlapPatchEmbed(patch_size=3, stride=1, in_chans=embed_dims[0], embed_dim=embed_dims[1])
        ...
        #-----------------------------------------------#
        self.patch_embed3 = OverlapPatchEmbed(patch_size=3, stride=1, in_chans=embed_dims[1], embed_dim=embed_dims[2])
        ...
        #-----------------------------------------------#
        self.patch_embed4 = OverlapPatchEmbed(patch_size=3, stride=1, in_chans=embed_dims[2], embed_dim=embed_dims[3])
