...
def train():
    ...
    # model = densenet.densenet_bc_121()
    # model = densenet.densenet_bc_81()
    model = densenet.densenet_bc_169()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model",
                        default="/workplace/project/Fire_MODIS_v3/classification/DenseNet/models_save/densenetbc169_1.pth")
    ...
    parser.add_argument("--test_batch", default=12150)
