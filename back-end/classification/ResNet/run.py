...
def test():
    ...
    log.log(str(args))
    # model = resnet.resnet34()
    model = resnet.resnet50(use_cbam=True)
    # model = resnet.resnet101()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model",
                        default="/workplace/project/Fire_MODIS_v3/classification/ResNet/models_save/cbam_resnet50_1.pth")
